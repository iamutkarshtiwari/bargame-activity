...
ActivityBase {
    ...
    pageComponent: Item {
        ...
        Image {
            id: backgroundImage
            source: Activity.url + "school_bg1.svg"
        ...
        Image {
            ...
            MouseArea {
                ...
                onEntered: {
                    parent.width = rootWindow.width / 18
                    parent.height = rootWindow.width / 18
                }
                onExited: {
                    parent.width = rootWindow.width / 20
                    parent.height = rootWindow.width / 20
                }
            }
            GCText {
                text: qsTr("OK")
        ...
        Image {
            ...
            MouseArea {
                ...
                onEntered: {
                    parent.width = rootWindow.width / 6;
                    parent.height = rootWindow.height / 7;
                }
                onExited: {
                    parent.width = rootWindow.width / 7;
                    parent.height = rootWindow.height / 8;
                }
            }
